...
if(!class_exists('Murmur_NestingLimitException'))
{
    ...
    $Murmur__t_NestingLimitException = IcePHP_defineException('::Murmur::NestingLimitException', 'Murmur_NestingLimitException', $Murmur__t_MurmurException, null);
}
...
if(!interface_exists('Murmur_ServerCallback'))
{
    ...
    IcePHP_defineOperation($Murmur__t_ServerCallback, 'userTextMessage', 2, 2, array($Murmur__t_User, $Murmur__t_TextMessage), null, null, null);
...
if(!interface_exists('Murmur_Server'))
{
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'effectivePermissions', 2, 2, array($IcePHP__t_int, $IcePHP__t_int), null, $IcePHP__t_int, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'setChannelState', 2, 2, array($Murmur__t_Channel), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException, $Murmur__t_NestingLimitException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'addChannel', 0, 0, array($IcePHP__t_string, $IcePHP__t_int), null, $IcePHP__t_int, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException, $Murmur__t_NestingLimitException));
